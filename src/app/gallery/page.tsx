import { GalleryFace, PaginationFace } from "@/ts/interfaces";
import React, { Suspense } from "react";
import { Metadata } from "next/types";
import Pagination from "@/components/Pages/Projects/Pagination";
import Header from "@/components/Pages/Gallery/Header";
import Error_v1 from "@/components/Error_v1";
import Loading from "@/components/Loading";
import dynamic from "next/dynamic";

// Lazy load projectCard component
const GalleryCard = dynamic(() => import("@/components/Card/GalleryCard"), {
  suspense: true,
});
...
export const metadata: Metadata = {
  title: "Our Gallery - 24x7 Rudra Creative Home Decor & Architects",
  description:
    "Discover our portfolio of stunning Gallery at 24x7 Rudra Creative Home Decor & Architects. Explore our innovative designs and home decor solutions tailored to clients in the Patna region.",
  keywords: [
    "gallery",
    "portfolio",
    "home decor projects",
