...
function page() {
  return (
    <div className="container mx-auto p-4 space-y-8 sm:space-y-16 md:space-y-24 lg:space-y-32">
      <section className="max-w-screen-lg mx-auto leading-normal space-y-8 *:space-y-3 [&_li]:text-accent-700 dark:[&_li]:text-accent-100 [&_li]:ml-4 [&_h4]:opacity-70">
        <header className="space-y-6 text-center pb-8">
          <h1 className="text-2xl text-gray-500 uppercase">terms of service</h1>
        ...
        <div>
          <p className="">
            <strong className="text-3xl">W</strong>elcome to
            rudracreativehomedecor.in! These terms and conditions outline the
            rules and regulations for the use of{" "}
            <strong>{`rudracreativehomedecor.in's`}</strong> Website, located at
            https://rudracreativehomedecor.in.
          </p>
          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use rudracreativehomedecor.in if you
        ...
        <div>
          ...
          <p>
            ...
            rudracreativehomedecor.in, you agreed to use cookies in agreement
            with the {`rudracreativehomedecor.in's`} Privacy Policy.
          </p>
          <p>
        ...
        <div>
          ...
          <p>
            Unless otherwise stated, rudracreativehomedecor.in and/or its
            licensors own the intellectual property rights for all material on
            rudracreativehomedecor.in. All intellectual property rights are
            reserved. You may access this from rudracreativehomedecor.in for
          ...
          <div>
            ...
            <ol className="list-decimal px-4">
              <li>Republish material from rudracreativehomedecor.in</li>
              <li>
                Sell, rent or sub-license material from
                rudracreativehomedecor.in
              </li>
              <li>
                Reproduce, duplicate or copy material from
                rudracreativehomedecor.in
              </li>
              <li>Redistribute content from rudracreativehomedecor.in</li>
            </ol>
          </div>
          <p>
          ...
          <p>
            rudracreativehomedecor.in reserves the right to monitor all Comments
          ...
          <p>
            You hereby grant rudracreativehomedecor.in a non-exclusive license
        ...
        <div>
          ...
          <p>
            ...
            rudracreativehomedecor.in; and (d) the link is in the context of
          ...
          <p>
            ...
            sending an e-mail to rudracreativehomedecor.in. Please include your
          ...
          <p>
            No use of {`rudracreativehomedecor.in's`} logo or other artwork will
